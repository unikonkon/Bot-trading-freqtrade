"""CdcActionZoneStrategy — subclass ของ BaseSignalStrategy สำหรับกลยุทธ์ 'cdc_actionzone'
...
class CdcActionZoneStrategy(BaseSignalStrategy):
    strategy_id = "cdc_actionzone"
