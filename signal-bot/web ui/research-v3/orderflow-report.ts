 ...
 *
 * ใช้ค่าตั้งต้นของทะเบียนเสมอ ซึ่งตอนนี้นับหน้าต่างเป็นแท่ง (240 / 5,760) — ที่ 30m เท่ากับผลเดิมทุกตัวเลข
 * แต่ timeframe อื่นจะต่างจากตัวเลขโหมดนับเป็นวันที่อ้างถึงในเอกสารก่อนหัวข้อ 14
 */
