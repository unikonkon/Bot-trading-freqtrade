...
2. เลือกแท่งล่าสุด 500–10,000 แท่ง เพิ่ม–ลดครั้งละ 500 หรือช่วงวัน/เวลาไทย (Asia/Bangkok)
...
6. แท็บ **ผลการทดสอบ** เรียงลำดับได้ทุกคอลัมน์ (กดหัวตาราง หรือใช้ช่อง เรียงตาม / ลำดับ) ค่าเริ่มต้นเรียงผลตอบแทนมากไปน้อย กรองเฉพาะโหมดที่สนใจและค้นหาด้วยชื่อกลยุทธ์ได้ กดชื่อกลยุทธ์ในตารางเพื่อตั้งเป็นกลยุทธ์หลักและเปิดกราฟของกลยุทธ์นั้น
